      ...
      <div className='content'>
        <div className='content__box'>
          ...
          <p className='content__box--text'>
            ...
            года, я занимаюсь web-разработкой, создание адаптивных сайтов с нуля, добавления новых элементов
        ...
        <div className='content__box'>
          ...
          <p className='content__box--text'>
            Меня всегда интересовала тема создания игр, сайтов, приложений и в 2020 году я начал изучать web по 
            начало это было просто хобби, но со временем я стал понимать, что хочу этим заниматься на профессиональном 
            уровне. Сейчас, ни один день не проходит без программирования и помимо того, что это очень интересно, IT
            дает возможность развиваться как личности.  
          </p>
        </div>
      </div>
